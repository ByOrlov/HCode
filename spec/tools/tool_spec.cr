...
describe Hcode::Tools::Tool do
  describe ".sanitize_output" do
    it "passes through clean UTF-8 unchanged" do
      cleaned = Hcode::Tools::Tool.sanitize_output("hello world\nline two\n")
    ...
    it "replaces invalid UTF-8 bytes and appends a notice" do
      ...
      cleaned = Hcode::Tools::Tool.sanitize_output(binary)

      cleaned.valid_encoding?.should be_true
      cleaned.should contain(Hcode::Tools::Tool::SANITIZE_NOTICE)
    ...
    it "strips C0 control bytes (except tab/newline/cr) and appends a notice" do
      ...
      cleaned = Hcode::Tools::Tool.sanitize_output(noisy)
