...
describe Kimi::Context::Memory do
  ...
  it "undo stops at compaction boundary" do
    ...
    mem.apply_compaction("summary", [] of Kimi::Context::ContextMessage)
  ...
  it "Undo.undo_or_raise! raises UndoLimitError when crossing a compaction boundary" do
    ...
    expect_raises(Kimi::Context::UndoLimitError) do
      Kimi::Context::Undo.undo_or_raise!(mem, 5)
    end
  ...
  it "Undo.undo_or_raise! raises when not enough user prompts" do
    ...
    expect_raises(Kimi::Context::UndoLimitError) do
      Kimi::Context::Undo.undo_or_raise!(mem, 3)
    end
  end
  ...
  it "prune_injections does not remove compaction summary" do
    ...
    mem.apply_compaction("summary text", [] of Kimi::Context::ContextMessage)
