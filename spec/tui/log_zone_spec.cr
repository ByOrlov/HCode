...
describe H2code::TUI::LogZone do
  it "emits only lines beyond the cursor and advances it" do
    zone = H2code::TUI::LogZone.new
    mock = H2code::TUI::TerminalMock.new
    ...
    mock2 = H2code::TUI::TerminalMock.new
  ...
  it "reset clears the cursor and the shrank flag" do
    ...
    zone.flush(H2code::TUI::TerminalMock.new, [] of String) # shrink → shrank
  ...
  it "mark_flushed aligns the cursor without emitting" do
    ...
    mock = H2code::TUI::TerminalMock.new
    zone.flush(mock, ["a", "b", "c", "d"] of String)
    zone.flush(H2code::TUI::TerminalMock.new, [] of String)
