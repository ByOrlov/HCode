...
describe Hcode::Plugin::CommandLoader do
  it "parses command with frontmatter" do
    text = "---\nname: report\ndescription: Generate report\n---\nGenerate a report for $ARGUMENTS"
    cmd = Hcode::Plugin::CommandLoader.parse_command_text(text, "/path/report.md", "my-plugin", "fallback")
